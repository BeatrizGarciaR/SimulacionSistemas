...
for(g in 1:5){
  ...
  tiempo.may <- max(datos[,6])
  tiempo.mayor <- rbind(tiempo.mayor, tiempo.may)
...
tiempo.max <- as.vector(t(tiempo.mayor))
plot(tiempo.max, xlab="Repetición", ylab="Tiempo de ejecución", type="o", col=4, pch=19, main="Unidades de tiempo", ylim=c(1000,2000))
#lines(tiempo.max1, type="o", col="green", pch=19)

ttiempo.p <- as.vector(t(tiempo.p))
plot(ttiempo.p, xlab="Repetición", ylab="Tiempo de ejecución del código", type="o", col=4, pch=19, main="Tiempo en segundos", ylim=c(0,65))
#lines(tiempo.max1, type="o", col="green", pch=19)
