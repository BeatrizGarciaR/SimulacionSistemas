...
plot(tiempo.max1, xlab="Repetición", ylab="Tiempo de ejecución", type="o", col="green",pch=19, main="Tiempo en segundos")
#lines(tiempo.max1, type="o", col="green", pch=19)

ttiempo.p1 <- as.vector(t(tiempo.p1))
plot(ttiempo.p1, xlab="Repetición", ylab="Tiempo de ejecución del código", type="o", col="green",pch=19, main="Tiempo en segundos")
