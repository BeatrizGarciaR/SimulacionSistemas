tiempo.p <- data.frame()
for (cant.cum in seq(10000, 110000, 20000)){
  t1 <- Sys.time()
  library(extrafont)
  library(ggplot2)
...
plot(ttiempo.p, xaxt="n", xlab="Variaciones en cantidad de cúmulos", ylab="Tiempo de ejecución", type="o", col=4, main="Tiempo en segundos")
#axis(side=1, at=seq(10000, 110000, 20000),tcl=0.4,lwd.ticks=3,mgp=c(0,0.5,0))
# col=2 es rojo (sin paralelizar), col=4 es azul (paralelizdo)