...
print(time)
tiempo.sp <- rbind(tiempo.sp, time)
}
stopCluster(cluster)
ttiempo.sp <- as.vector(t(tiempo.sp))
lines(ttiempo.sp, xaxt="n", xlab="Variaciones en cantidad de cúmulos", ylab="Tiempo de ejecución", type="o", col=2, main="Tiempo en segundos")
